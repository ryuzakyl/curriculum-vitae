...
%    \emph{Relators: Prof. Enzo Mingozzi, Ing. Carlo Vallati, Prof. Luciano Lenzini.}\\}
  ...
  \entry
    ...
    {Universidad de La Habana, Cuba}
    {Título de Oro (\textbf{\emph{summa cum laude}}) en Ciencia de la Computación. Materias principales: Programación, Estructuras de Datos y Algoritmos, Teoría de la Complejidad Computacional, Matemática, Investigación Operacional, Matemática Numérica e Inteligencia Artificial.\\
