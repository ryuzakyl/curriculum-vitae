...
\begin{entrylist}
  ...
  \entry
    ...
    {Diseño y desarrollo de Sistemas de Reconocimiento de Patrones. Investigador Júnior y estudiante de doctorado. Con intereses en temas como Visión por Computadoras, Análisis de Datos, Representación de Datos, Agrupamiento y Clasificación. Tecnologías: Python, Numpy, SciPy, Matplotlib, scikit-learn, etc.\\}
...
\begin{entrylist}
  \entry
    ...
    {}
    {}
    {\textbf{C\#} (+8 años), \textbf{Python} (+6 años), \textbf{C/C++} (+4 años), \textbf{Ruby} (+3 años). Otras tecnologías incluyen \textbf{Java}, \textbf{PHP} y \textbf{Go}. }
