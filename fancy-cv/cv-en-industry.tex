...
\begin{entrylist}
  ...
  \entry
    ...
    {}
    {}
    {\textbf{HTML}, \textbf{CSS3}, \textbf{JavaScript}, \textbf{jQuery}, \textbf{PHP}, \textbf{Django}, \textbf{Django Rest Framework}, \textbf{ASP.NET MVC} and \textbf{Ruby on Rails}.}
  ...
  \entry
    ...
    {}
    {}
    {\textbf{GNU/Linux} (Ubuntu, Linux Mint) and \textbf{Microsoft Windows} (XP, 7, 8, 8.1, 10).}
\end{entrylist}
\\
